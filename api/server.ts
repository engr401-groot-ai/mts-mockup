...
/**
 * POST /api/sheet/suggest
 *
 * Adds a suggestion to the Google Sheets spreadsheet.
 */
app.post('/api/sheet/suggest', async (req: Request, res: Response) => {
